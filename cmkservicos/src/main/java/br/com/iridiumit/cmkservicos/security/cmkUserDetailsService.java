...
import static br.com.iridiumit.cmkservicos.utils.JdbcUtils.*;
...
@Component
public class cmkUserDetailsService implements UserDetailsService {

	private static final Logger logger = Logger.getLogger(cmkUserDetailsService.class.getSimpleName());
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			cmkUserDetails userDetails = buscarUsuario(connection, login);
	...
	public cmkUserDetails buscarUsuario(Connection connection, String login) throws SQLException {
		...
		return new cmkUserDetails(nome, login, password, ativo);
	}
